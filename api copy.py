...
#2# MÓDULO DE PERFIL (Obtener datos del usuario autenticado)
...
# ==========================
# 3  MÓDULO DE USUARIOS (Administrativos)
# ==========================
...
# ==========================
# 4 MÓDULO DE ALUMNOS (Inscripción y Listado)
# ==========================
...
#5# MÓDULO DE ALUMNOS: INSCRIPCIÓN (Con Auto-Generación de Deuda)
...
# ==========================================
# ✏️ 6 ACTUALIZAR ALUMNO (Con Auto-Generación de Deuda)
# ==========================================
...
def actualizar_estatus_alumno(matricula_original):
    ...
    try:
        ...
        return jsonify({"error": str(e)}), 500
# ==========================
# 🚀 7 PROMOCIÓN MASIVA (Con Auto-Generación de Deuda)
# ==========================
...
# ==========================
# 🎯 8 PROMOCIÓN SELECTIVA (Con Auto-Generación de Deuda)
# ==========================
...
#9# MÓDULO DE ALUMNOS: ELIMINAR ALUMNO
...
def eliminar_alumno(matricula):
    ...
    try:
        ...
        return jsonify({"error": str(e)}), 500
# ==========================
# ✅ 10 MÓDULO DE GENERACIONES (Con Meses Reales)
# ==========================
...
# ==========================
# 📋11 LISTAR GENERACIONES (A prueba de fechas nulas)
# ==========================
...
# ✅ 12 Ruta PUT para editar y cambiar estado ("Apagar" Generación)
...
#15# MÓDULO DE GRUPOS: LISTAR GRUPOS CON NÚMERO DE ALUMNOS ACTIVOS
...
#16# MÓDULO DE GRUPOS: ACTUALIZAR GRUPO (Con Validación de Duplicados)
...
# ==========================================
# 💰 17 MÓDULO FINANCIERO: ESTRUCTURA DE PAGOS
# ==========================================
...
#18# MÓDULO DE ESTRUCTURA DE PAGOS: CREAR NUEVO CONCEPTO (Con Validación de Campos)
...
#19# MÓDULO DE ESTRUCTURA DE PAGOS: ELIMINAR CONCEPTO (Con Validación de Relaciones)
...
# ==========================================
# 💵 20 MÓDULO DE CAJA (PUNTO DE COBRO)
# ==========================================
...
# ==========================================
# 💵 21 MÓDULO DE CAJA: LISTADO DE COBRO Y CAJA
# ==========================================
...
# ==========================================
# 📊 22 API: OBTENER HISTORIAL DE PAGOS (Ajuste para fecha cruda)
# ==========================================
...
# ==========================================
# 🔄 23 API: REVERTIR PAGO (APAGAR BOTÓN)
# ==========================================
...
def revertir_pago(id_pago):
    ...
    try:
        ...
        return jsonify({"error": str(e)}), 500
# ==========================================
# 💸24 API: REGISTRAR UN PAGO FÍSICO (Asentar Folio)
# ==========================================
...
# ==========================================
# ➕ 25 API: CREAR UN COBRO DESDE EL MODAL
# ==========================================
...
# ==========================================
# ✏️26 API: EDITAR CUALQUIER DATO DE UN COBRO
# ==========================================
...
# ==========================================
# 🗑️ 27 API: ELIMINAR UN COBRO PENDIENTE
# ==========================================
...
# ==========================================
# 🔐 28 API: ACTUALIZAR CONTRASEÑA (Usando SQLAlchemy)
# ==========================================
...
# ==========================================
# 👤29 API: ACTUALIZAR INFORMACIÓN PERSONAL
# ==========================================
